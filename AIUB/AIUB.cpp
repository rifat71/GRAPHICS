...
char redCarStart[] = "Press 's' to start the Red Car";
char yellowCarStart[] = "Press 'g' to start the Yellow Car";
char redCarPause[] = "Press 'd' to Pause the Red Car";
char yellowCarPause[] = "Press 'h' to Pause the Yellow Car";
char nightview[] = "Press 'n' for night view";
char dayview[] = "Press 't' for day view";
char t[] = "End";
int h=0;
int n=0;
int tt=1;
...
float carWheelAngleRafi = 0.0;
float _cameraAngleCar = 0.0;
float initialCarPosi = -8;
float initialCarPosition =8;
float rafiCarPosi = -8;
float posCar = 0.0;
float posCar2 = 0.0;
...
//     glPopMatrix();
    ...
    if(h==1)
    {
        ...
        Sprint(-1.5,.8,redCarStart);
        Sprint(-1.5,.5,redCarPause);
        Sprint(-1.5,.2,yellowCarStart);
        Sprint(-1.5,-.1,yellowCarPause);
        Sprint(-1.5,-.4,dayview);
        Sprint(-1.5,-.7,nightview);
        glPopMatrix();
    ...
    else
    {
        ...
        glPushMatrix();
          ...
          glScalef(.7,.5,0);
        glPushMatrix();
           glRotatef(rotate_flag,0,1,0);
        glPushMatrix();  /// Green portion
          //
           glPushMatrix();
           glColor3ub(255,0,0);   /// Red Portion
           glutSolidTorus(.04,.04,10,20);
           glPopMatrix();
     ...
     glPushMatrix();
    glTranslatef(initialCarPosition, -2.72, 0.0);


    glPushMatrix();
    glScalef(0.67,0.67,0);
...
///Car Rafi
    ...
    glPushMatrix();
    glTranslatef(rafiCarPosi,-2.55,0);
...
///Goal Post End
        ...
        glPushMatrix();  /// TREE-5(from left) lower portion  ///////////
        glTranslatef(-2,-.7,0);
        glColor3ub(139,69,19);
        glBegin(GL_POLYGON);
        glVertex3f(-2,0.6,0);
        ...
        glPushMatrix();  /// TREE-5(from left) Main portion lower  ///////////
        glTranslatef(-3.9,-.25,0);
        glRotatef(-90,1,0,0);
        glColor3ub(0,255,0);
        glutSolidCone(.3,.6,15,15);
        ...
        glPushMatrix();  /// TREE-5(from left) Main portion upper  ///////////
        glTranslatef(-3.9,0,0);
        glRotatef(-90,1,0,0);
        glColor3ub(0,255,0);
        glutSolidCone(.3,.6,15,15);
...
///
        ...
        glBegin(GL_POLYGON);   ///Annex-2 Red portion
        glColor3f(.7,0,0);
        glVertex2f(-5,-.2);
        glVertex2f(5,-.2);
        glVertex2f(5,.55);
...
//      glVertex2f(2.5,.25);
    ...
    ///NIGHT VIEW  /// NIGHT VIEW ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW  ///NIGHT VIEW
    ///
    ///
    ///
    ///
...
void update(int value)
{
    ...
    carWheelAngleRafi += 2.0f;
    if (carWheelAngleRafi > 360)
    {
        carWheelAngleRafi -= 360;
    }
...
void updateCar(int value)
{
    ...
    initialCarPosition -= posCar2;
    if (initialCarPosition < -7)
    {
        initialCarPosition =8;
    }
...
int main(int argc, char** argv)
{
    ...
    glutTimerFunc(40, updateCar, 0); //Add a timer
